...
#               encounters a syntax error in the code, such as a misspelled keyword,
#               a missing colon, or an unbalanced parenthesis.
# TypeError: This exception is raised when an operation or
#             function is applied to an object of the wrong type,
...
# IndexError: This exception is raised when an index
#               is out of range for a list, tuple, or other sequence types.
# KeyError: This exception is raised when a key is
#           not found in a dictionary.
# ValueError: This exception is raised when a function or
#               method is called with an invalid argument or input, such as trying to convert a string to an integer when the string does not represent a valid integer.
# AttributeError: This exception is raised when an attribute or
#                   method is not found on an object, such as trying to access a non-existent attribute of a class instance.
...
# ZeroDivisionError: This exception is raised when an attempt
